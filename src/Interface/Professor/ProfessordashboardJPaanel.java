...
public class ProfessordashboardJPaanel extends javax.swing.JPanel {
    ...
    public ProfessordashboardJPaanel(JPanel userProcessContainer, StudentDetails sd, Professor professor, CourseCatalog courseCatalog) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.courseCatalog = courseCatalog;
        this.professor = professor;
        this.sd = sd;
        welcomeLbl.setText(professor.getFull_name());
        ratingTextArea.setText("Your rating : " + professor.getRating());
        populateTable();
    }
    ...
    private void createCourseBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createCourseBtnActionPerformed
        // TODO add your handling code here:
        CreateCourseJPanel createCourseJPanel = new CreateCourseJPanel(userProcessContainer, sd, professor, courseCatalog);
    ...
    private void btnViewProfileDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewProfileDetailsActionPerformed
        // TODO add your handling code here:
        UpdateProfessorProfileJPanel viewFacultyProfileJPanel = new UpdateProfessorProfileJPanel(userProcessContainer, professor);
    ...
    private void populateTable() {
        ...
        for (Course course : courseCatalog.getCourseList()) {
            if (course.getFaculty().getFull_name().equals(this.professor.getFull_name())) {
