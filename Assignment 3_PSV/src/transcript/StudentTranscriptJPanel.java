...
import transcript.TranscriptPDF;
...
public class StudentTranscriptJPanel extends javax.swing.JPanel {
    ...
    public StudentTranscriptJPanel(Business business, Student student, CourseCreationHistory courseCreationHistory, JPanel CardSequencePanel) {
         initComponents();
        this.business = business;
        this.student = student;
        this.courseCreationHistory = courseCreationHistory;
        student_id= student.getStudnet().getId();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String studentInfo = "Student Name: "+ student_id+" Student ID: " + Userid + "  " +
                "Student Batch: " + "2023";
        ...
        contentStream.endText();
        // Draw table data
        for (Course course : CourseCreationHistory.findCourseListByStudentProfile(student)) {
            yPosition -= 20; // Adjust this value if needed
            String rowData = course.getCourseName() + "          " + course.getCredit() + "          A"; // Adjust for actual data
            contentStream.beginText();
            contentStream.newLineAtOffset(margin, yPosition);
    ...
    txtUserid.setText(student.getNUID());
    ...
    for (CourseCreation course : courseCreationHistory.getCourseHistory()) {
        ...
        row[2] = getGradeForCourse(course.getCourseID()); // You need to implement getGradeForCourse
        model.addRow(row);
    }
    }
}
